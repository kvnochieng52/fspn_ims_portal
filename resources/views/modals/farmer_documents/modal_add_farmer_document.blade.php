<div class="modal fade" id="add_farmer_document">

    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            {!!
            Form::open(['action'=>'FarmerDocumentController@store','method'=>'POST','class'=>'form
            user_form',
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            {{ Form::select('document', $farmer_document_types,null, ['style'=>'width:100%','class' => 'select2 form-control','placeholder'=>'--Specify--','required'=>'required']) }}
                        </div>
